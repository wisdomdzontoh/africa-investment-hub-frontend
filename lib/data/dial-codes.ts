// E.164 international calling codes keyed by ISO 3166-1 alpha-2 (lowercase),
// matching the codes used in WORLD_COUNTRIES / COUNTRIES. Shared-code
// territories carry their standard prefix (e.g. us/ca "+1", NANP islands
// "+1"). Used by the onboarding PhoneField country-code picker.
...
export const DIAL_CODES: Record<string, string> = {
  ...
  cm: "+237", ca: "+1", ky: "+1", cf: "+236", td: "+235", cl: "+56",
  cn: "+86", co: "+57", km: "+269", cg: "+242", cd: "+243", ck: "+682",
  cr: "+506", ci: "+225", hr: "+385", cu: "+53", cw: "+599", cy: "+357",
  cz: "+420", dk: "+45", dj: "+253", dm: "+1", do: "+1", ec: "+593",
  ...
  it: "+39", jm: "+1", jp: "+81", je: "+44", jo: "+962", kz: "+7",
  ...
  mc: "+377", mn: "+976", me: "+382", ms: "+1", ma: "+212", mz: "+258",
  mm: "+95", na: "+264", nr: "+674", np: "+977", nl: "+31", nc: "+687",
  nz: "+64", ni: "+505", ne: "+227", ng: "+234", nu: "+683", nf: "+672",
  mk: "+389", mp: "+1", no: "+47", om: "+968", pk: "+92", pw: "+680",
  ps: "+970", pa: "+507", pg: "+675", py: "+595", pe: "+51", ph: "+63",
  pl: "+48", pt: "+351", pr: "+1", qa: "+974", re: "+262", ro: "+40",
  ru: "+7", rw: "+250", bl: "+590", sh: "+290", kn: "+1", lc: "+1",
  mf: "+590", pm: "+508", vc: "+1", ws: "+685", sm: "+378", st: "+239",
  sa: "+966", sn: "+221", rs: "+381", sc: "+248", sl: "+232", sg: "+65",
  sx: "+1", sk: "+421", si: "+386", sb: "+677", so: "+252", za: "+27",
  ss: "+211", es: "+34", lk: "+94", sd: "+249", sr: "+597", sj: "+47",
  se: "+46", ch: "+41", sy: "+963", tw: "+886", tj: "+992", tz: "+255",
  th: "+66", tl: "+670", tg: "+228", tk: "+690", to: "+676", tt: "+1",
  tn: "+216", tr: "+90", tm: "+993", tc: "+1", tv: "+688", ug: "+256",
  ua: "+380", ae: "+971", gb: "+44", us: "+1", uy: "+598", uz: "+998",
  vu: "+678", va: "+39", ve: "+58", vn: "+84", vg: "+1", vi: "+1",
  wf: "+681", eh: "+212", ye: "+967", zm: "+260", zw: "+263",
};

export function dialCode(iso: string | undefined): string | undefined {
  return iso ? DIAL_CODES[iso.toLowerCase()] : undefined;
}
